        ...
        <Transition name="fade" mode="out-in">
          <div class="w-full" :key="route.path">
            ...
            <template #fallback>
              <div>
                <div
                  class="absolute top-1/2 transform -translate-y-1/2 left-1/2
                  -translate-x-1/2 flex justify-center items-center w-full h-screen
                  bg-background bg-opacity-90 z-50"
                >
                  <iconify-icon
